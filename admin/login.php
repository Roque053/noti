<?php
    ...
    if ($nfilas > 0) {
        ...
        // Verificar si el usuario es el administrador general)
        ...
        $_SESSION['mensaje'] = "Usuario y contraseña incorrectos";
        header("location: index.php?mensaje=Usuario y contraseña incorrectos");
    }
